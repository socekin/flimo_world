...
const systemVersion = storyData?.plot_outlines?.system_version || {};
...
export const storyTitle = systemVersion.title || fallbackTitle;

// 与 StoryIntro 页面文案保持一致，供 Play 模式初始化会话使用（使用 system_version）
export const storyWorldSetting = (systemVersion.content || fallbackContent).trim();
