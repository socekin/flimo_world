    ...
    return (
        <div ref={barRef} className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between h-9 px-3 bg-black/20 backdrop-blur-sm">
            ...
            <div className="flex items-center gap-4">
                <span className="text-white/80 text-sm font-medium truncate max-w-48">{title}</span>
                <span className="text-white text-sm font-mono tracking-wider">{formatTime(currentTime)}</span>
            </div>
